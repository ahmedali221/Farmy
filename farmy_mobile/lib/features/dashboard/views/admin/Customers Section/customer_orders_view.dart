          ...
          slivers: [
            ...
            SliverToBoxAdapter(
              child: Container(
                ...
                child: ListTile(
                  contentPadding: EdgeInsets.zero,
                  leading: Icon(Icons.list_alt, color: Colors.green, size: 20),
                  title: Text(
                    ...
                    child: Center(
                      child: Column(
                        ...
                        children: [
                          ...
                          SizedBox(height: 8),
                          Text(
                            'لم يتم تسجيل أي طلبات لهذا العميل بعد',
      ...
      child: ExpansionTile(
        ...
        subtitle: Column(
          ...
          children: [
            ...
            Text(
              'التاريخ: ${_formatDate(order['orderDate'])}',
              style: TextStyle(color: Colors.grey[600], fontSize: 12),
            ),
            Container(
