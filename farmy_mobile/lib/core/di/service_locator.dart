...
import '../services/waste_api_service.dart';
...
class ServiceLocator {
  static Future<void> init() async {
    ...
    serviceLocator.registerSingleton<DistributionApiService>(
      DistributionApiService(tokenService: serviceLocator<TokenService>()),
    );
    ...
    serviceLocator.registerSingleton<WasteApiService>(
      WasteApiService(tokenService: serviceLocator<TokenService>()),
    );
